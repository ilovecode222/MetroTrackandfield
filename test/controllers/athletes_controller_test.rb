...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference("Athlete.count") do
      post athletes_url, params: { athlete: { grade: @athlete.grade, name: @athlete.name, school: @athlete.school } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { grade: @athlete.grade, name: @athlete.name, school: @athlete.school } }
